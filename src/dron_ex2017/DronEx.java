...
public class DronEx extends JPanel implements Runnable, KeyListener,ActionListener {
	...
	public DronEx(Main const_main, String s, Sounds soundObject) {
		...
		// -- ゲームの中断 --
		pause_n = new ImageIcon(getClass().getResource("/images/pauseButton/pauseButton_n.png"));
		pause_h = new ImageIcon(getClass().getResource("/images/pauseButton/pauseButton_h.png"));
	    pause_p = new ImageIcon(getClass().getResource("/images/pauseButton/pauseButton_p.png"));
		...
		// -- ゲームを続ける --
		replay_n = new ImageIcon(getClass().getResource("/images/replayButton/replayButton_n.png"));
		replay_h = new ImageIcon(getClass().getResource("/images/replayButton/replayButton_h.png"));
		replay_p = new ImageIcon(getClass().getResource("/images/replayButton/replayButton_p.png"));
		...
		// -- ゲームを終了してメニューに戻る --
		// サイズ変更OK?
		backToMenu_n = new ImageIcon(getClass().getResource("/images/backMenuButton_game/backToMenu_g_n.png"));
		backToMenu_h = new ImageIcon(getClass().getResource("/images/backMenuButton_game/backToMenu_g_h.png"));
		backToMenu_p = new ImageIcon(getClass().getResource("/images/backMenuButton_game/backToMenu_g_p.png"));
	...
	public void run() {
		...
		while (thisThread == thread) {
			...
			while (liveL && liveR) {
				...
				if(yL >= (250 / block) && yL <= (270 / block) && xL >= (100 / block) && xL <= (350 / block)) {
					liveL = false;
				}
				if(yR >= (100 / block) && yR <= (120 / block) && xR >= (50 / block) && xR <= (300 / block)) {
					liveR = false;
				}
				if(yR >= (250 /block) && yR <= (270 / block) && xR >= (100 / block) && xR <= (350 /block)) {
					liveR = false;
				}
